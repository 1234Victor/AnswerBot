...
def user_input():
    ...
    2) Short answer (max 2 sentences) to any explicid customer questions that begins with an asterisk '*' followed by an explanation that uses all your knowledge to answer the question about the products recommended.
    ...
    ''')
        ...
        print(e)
        history = []
        return jsonify({"message": "Error Occurs. Please enter your needs again", "products": []})
